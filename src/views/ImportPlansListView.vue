    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="mt-2 text-gray-600">Gerencie suas importações de registros</p>
            </div>
        ...
        <div v-if="loading" class="text-center py-12">
            ...
            <p class="mt-4 text-gray-600">Carregando importações...</p>
        </div>
                        ...
                        <div class="flex-1">
                            ...
                            <div class="grid gap-2 text-sm text-gray-600">
                                ...
                                <div v-if="plan.confirmed_at" class="flex items-center gap-2 text-green-600">
                                    ...
                                    <span>Confirmado em {{ formatDate(plan.confirmed_at) }}</span>
                                </div>
                            </div>
                            ...
                            <div v-if="plan.summary" class="mt-4 flex gap-6 text-sm">
                                ...
                                <div>
                                    <span class="text-gray-600">Válidos:</span>
