    ...
    <template #default>
      ...
      >
        ...
        <span class="flex items-center gap-2">
          <span
            class="h-8 w-8 rounded-md bg-red-600 text-white flex items-center justify-center
      ...
      <div class="p-3 space-y-3">
        ...
        <div class="space-y-1">
          ...
          <button
            ...
            :key="client.id"
            class="w-full flex items-center justify-between gap-2 rounded-md px-3 py-2
                   text-sm hover:bg-gray-100 text-left"
            @click="emit('select', client)"
          >
            <div class="flex items-center gap-2">
              <span
                class="h-6 w-6 rounded-md bg-red-600 text-white flex items-center justify-center
